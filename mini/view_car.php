    ...
    <style>
       ...
       .carousel slide{
        ...
        .card {
            ...
            width: 41rem;
            height: 260px;
            margin: 20px auto; /* Adjust the bottom margin as needed */
           padding-left:38px;
        ...
        .modal-body img {
            ...
            width: 70vh; /* Ensure images maintain their aspect ratio */
            display: flex; 
    flex-direction: row;
    flex-wrap: wrap;
    margin:16px;
            ...
            button.addEventListener('click', function () {
                ...
                for (var i = 0; i < imagePaths.length; i++) {
                    if (imagePaths[i]) {
                        ...
                        item.innerHTML = '<img src="profile_pictures/' + imagePaths[i] + '" class="d-block w-100" alt="Image ' + (i + 1) + '">';
